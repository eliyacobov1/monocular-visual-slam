"""Benchmark for optimization control plane telemetry overhead."""
...
def build_graph(num_poses: int) -> PoseGraph:
    graph = PoseGraph(
        ...
        solver_config=SolverConfig(max_iterations=12, linear_solver_max_iter=80),
...
def main() -> None:
    ...
    output_path = Path("artifacts") / "optimization_control_plane_benchmark.json"
